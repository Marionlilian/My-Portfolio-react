...
Front-End Developer
      ...
      <div class="flex justify-center mx-auto">
        <Link to="/Contact" className="inline-flex text-white bg-rose-400 border-0 py-2 px-6 
             focus:outline-none hover:bg-pink-300 rounded text-lg cursor-pointer">Contact Me
       </Link>
